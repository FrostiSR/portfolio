...
export const ABOUT = {
    ...
    about:{
        left: {
            ...
            content:
            `I’m Daniel dos Ramos from Suriname: a creative tech enthusiast with a solid foundation in ICT, having graduated from Natin-MBO as an ICT Application Developer. With over 3 years of experience in web development and graphic design, I combine technical skills (including HTML5, PHP, NodeJS, ReactJS, JavaScript, CSS, SQL, and MongoDB) with a strong focus on user experience. I’m currently studying Communication and Multimedia Design at Hogeschool Rotterdam, where I’m further developing my passion for creating intuitive, visually appealing digital products. My goal is to become a successful UX/UI designer or front-end developer who builds smart, user-friendly solutions that truly help people.`
        },
        right: {
